...
func Test_Discover_isValid(t *testing.T) {
	...
	tts := []testCase{
		...
		{"special chars action in root 1", "actions/foo bar/action.yaml", false},    // Actions are located in root and with special characters.
		{"special chars action in root 2", "actions/foo!bar/action.yaml", false},    // Actions are located in root and with special characters.
		{"special chars action 1", "?/actions/foo/action.yaml", false},              // Actions with special characters.
		{"special chars action 2", "foo/actions/foo<>bar/action.yaml", false},       // Actions with special characters.
		{"special chars action 3", "foo/!<>/actions/foo\\bar/action.yaml", false},   // Actions with special characters.
		{"special chars action 4", "foo bar/actions/baz/action.yaml", false},        // Actions with special characters.
